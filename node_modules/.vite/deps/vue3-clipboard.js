  ...
  !function(t, e) {
    ...
    return o = {}, r.m = n = [function(t, e) {
      t.exports = function(t2) {
        var e2;
        if (t2.nodeName === "SELECT")
          t2.focus(), e2 = t2.value;
        else if (t2.nodeName === "INPUT" || t2.nodeName === "TEXTAREA") {
      ...
      n2.r(e);
      var o2 = n2(0), r2 = n2.n(o2), i = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t2) {
        return typeof t2;
      } : function(t2) {
      ...
      var l = (function(t2, e2, n3) {
        ...
        key: "resolveOptions",
        value: function(t2) {
          var e2 = 0 < arguments.length && t2 !== void 0 ? t2 : {};
        ...
        key: "selectFake",
        value: function() {
          var t2 = this, e2 = document.documentElement.getAttribute("dir") == "rtl";
        ...
        key: "action",
        set: function(t2) {
          var e2 = 0 < arguments.length && t2 !== void 0 ? t2 : "copy";
          if (this._action = e2, this._action !== "copy" && this._action !== "cut")
        ...
        set: function(t2) {
          if (t2 !== void 0) {
            if (!t2 || (t2 === void 0 ? "undefined" : i(t2)) !== "object" || t2.nodeType !== 1)
              throw new Error('Invalid "target" value, use a valid Element');
            if (this.action === "copy" && t2.hasAttribute("disabled"))
              throw new Error('Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute');
            if (this.action === "cut" && (t2.hasAttribute("readonly") || t2.hasAttribute("disabled")))
      ...
      }]), c), u = n2(1), s = n2.n(u), f = n2(2), d = n2.n(f), h = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t2) {
        return typeof t2;
      } : function(t2) {
        return t2 && typeof Symbol == "function" && t2.constructor === Symbol && t2 !== Symbol.prototype ? "symbol" : typeof t2;
      }, p = function(t2, e2, n3) {
      ...
      var m = (function(t2, e2) {
        ...
        value: function(t2) {
          var e2 = 0 < arguments.length && t2 !== void 0 ? t2 : {};
          this.action = typeof e2.action == "function" ? e2.action : this.defaultAction, this.target = typeof e2.target == "function" ? e2.target : this.defaultTarget, this.text = typeof e2.text == "function" ? e2.text : this.defaultText, this.container = h(e2.container) === "object" ? e2.container : document.body;
        }
      }, {
        key: "listenClick",
        value: function(t2) {
        ...
        key: "isSupported",
        value: function(t2) {
          var e2 = 0 < arguments.length && t2 !== void 0 ? t2 : ["copy", "cut"], n3 = typeof e2 == "string" ? [e2] : e2, o3 = !!document.queryCommandSupported;
...
// dep:vue3-clipboard
var vue3_clipboard_default = vue3_clipboard_es_default;
export {
  copyText,
  vue3_clipboard_default as default
};
/*!
 * clipboard.js v2.0.6

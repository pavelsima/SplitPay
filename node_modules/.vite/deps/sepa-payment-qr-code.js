...
// node_modules/is-currency-code/currency-codes.json
var require_currency_codes = __commonJS({
  "node_modules/is-currency-code/currency-codes.json"(exports, module) {
    module.exports = [
      "aed",
      "afn",
      "all",
...
// node_modules/is-currency-code/index.js
var require_is_currency_code = __commonJS({
  "node_modules/is-currency-code/index.js"(exports, module) {
    var currencyCodes = require_currency_codes();
    module.exports = (code) => {
...
// node_modules/sepa-payment-qr-code/node_modules/iban/iban.js
var require_iban = __commonJS({
  "node_modules/sepa-payment-qr-code/node_modules/iban/iban.js"(exports) {
...
// node_modules/sepa-payment-qr-code/index.js
var require_sepa_payment_qr_code = __commonJS({
  "node_modules/sepa-payment-qr-code/index.js"(exports, module) {
    "use strict";
    var isCurrencyCode = require_is_currency_code();
    var { isValid: isValidIBAN, electronicFormat: serializeIBAN } = require_iban();
    var SERVICE_TAG = "BCD";
    var VERSION = "002";
    var CHARACTER_SET = 1;
    var IDENTIFICATION_CODE = "SCT";
    var assertNonEmptyString = (val, name) => {
    ...
    var generateQrCode = (data) => {
      ...
      data = Object.assign(/* @__PURE__ */ Object.create(null), defaults, data);
      if (isValidIBAN(data.payeeIBAN))
        throw new Error("data.payeeIBAN must be a valid IBAN.");
      assertNonEmptyString(data.name, "data.name");
      if ("bic" in data)
        assertNonEmptyString(data.bic, "data.bic");
      if (typeof data.amount !== "number")
        throw new Error("data.amount must be a number.");
      if (data.amount < 0.01 || data.amount > 99999999999e-2) {
...
// dep:sepa-payment-qr-code
var sepa_payment_qr_code_default = require_sepa_payment_qr_code();
export {
  sepa_payment_qr_code_default as default
};
//# sourceMappingURL=sepa-payment-qr-code.js.map
